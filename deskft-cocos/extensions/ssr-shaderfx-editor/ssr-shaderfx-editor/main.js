...
window.boot = function () {
    ...
    if (typeof(Editor) != "undefined") {
        ...
        cc.assetManager.downloader._downloaders.bundle = function (nameOrUrl, options, onComplete) {
            ...
            url = Path.join(__dirname, '../ssr-shaderfx-editor/assets/' + bundleName);
            ...
            function (err, scene) {
                if (!err) {
                    ...
                    if (cc.sys.isBrowser) {
                        ...
                        var div = document.getElementById("dock").shadowRoot.childNodes[7].childNodes[0].childNodes[1].childNodes[0].shadowRoot.getElementById("GameDiv");
                        div.style.width = "100%";
